    ...
    <div className="space-y-6 p-4 md:p-6 dark:bg-gray-900">
      ...
      <Card className="shadow-lg border-border/50 border-gray-200 dark:border-gray-700">
        ...
        <CardContent className="px-4 md:px-6">
          <div className="overflow-x-auto hidden md:block rounded-lg border border-gray-200 dark:border-gray-700 border-border dark:border-border-dark">
            {/* Desktop Table */}
            <table className="hidden md:table min-w-full divide-y divide-gray-200 dark:divide-gray-700 divide-border dark:divide-border-dark">
              ...
              <tbody className="dark:bg-gray-900 divide-y divide-border divide-gray-200 dark:divide-gray-700 dark:divide-border-dark">
