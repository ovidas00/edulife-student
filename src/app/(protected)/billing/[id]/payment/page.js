...
const Payment = () => {
  ...
  return (
    <div className="flex items-center bg-gray-50 dark:bg-gray-900 py-8 px-4">
      ...
      <div className="max-w-md mx-auto">
        {!isSuccess ? (
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="flex items-center gap-2 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border dark:border-gray-600">
                    <span className="flex-1 font-mono text-lg font-semibold text-gray-900 dark:text-white">
                    ...
                    <button
                      ...
                      className={`p-2 rounded-md transition-colors ${
                        copied
                          ...
                          : "bg-gray-200 dark:bg-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-500 cursor-copy"
                      }`}
                    >
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md mx-auto text-center">
            ...
            <button
              className="bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 font-medium py-1 cursor-pointer px-6 rounded-md transition-colors text-gray-800 dark:text-white"
              onClick={() => router.back()}
            >
              Back to Dashboard
            </button>
